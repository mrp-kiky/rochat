...
$role_id = isset($_GET['role_id']) ? $_GET['role_id'] : '';
 ...
 $sql = "SELECT * FROM role WHERE role_id = '".$role_id ."' " ;//and role_created_by = '".$_SESSION['i']."' "; 
 $result = $db->rawQuery($sql);//@mysql_query($sql);
//  echo $sql;
//  var_dump($result); die;
if(!$result)
{
  echo '<script>alert("No Data Found.!!");window.location="role";</script>';
}
// if($result[0]['role_status']==1)
// {
//     echo '<script>alert("Data Already Submitted");window.location="role";</script>';
// }
                ...
                <div class="tab-content">
                  ...
                  <div class="active tab-pane" id="update">
                    <form id="roleform" class="form-horizontal" action="#"  enctype="multipart/form-data" method="post">
                          <input type="hidden" class="form-control" id="role_id" name="role_id" value="<?=$role_id?>">
                    ...
                    <!-- <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <select class="form-control select2bs4" id="role_user_tipe" name="role_user_tipe">
                            <?php
                              if($tipe_user == "ADMIN") {
                                $arr_tipe_user = array("SOCSO" => "SOCSO","NGO" => "NGO","VZ" => "VISION ZERO","MAINTENANCE" => "MAINTENANCE","ADMIN" => "ADMIN");
                              }
                              else
                              {
                              ...
                              {
                                $selected = " ";
                                  if($result[0]['role_user_tipe'] == $value )
                                  {
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          ...
                          <input type="text" class="form-control" id="role_url" name="role_url" placeholder="ex. newoshe" value="<?=$result[0]['role_url']?>" >
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="role_action" name="role_action" placeholder="ex. actioncreate"  value="<?=$result[0]['role_action']?>" >
                      ...
                      <div class="form-group row">
                        ...
                        <?php
                                ...
                                {
                                  $selected = " ";
                                    if($result[0]['role_status'] == $value )
                                    {
                                      $selected = 'selected="selected"';
                                    }
                                    if($result[0]['role_status'] == 0)
                                    {
                                        echo "<option value='".$value."' ".$selected ." > Nonaktif </option>" ;
                                    }
                                    else
                                    {
